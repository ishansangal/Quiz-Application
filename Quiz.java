...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String name){
        ...
        submit.setBounds(900,710,200,40);
 ...
 if (useranswers[i][0] != null && useranswers[i][0].equals(answers[i][1])) {             score +=10;
             } else {  // if you want then use in negative marking
             score += 0; 
               }
             }
    ...
    public void paint (Graphics g){
         ...
         g.setFont(new Font("Railway", Font.BOLD,25));
         ...
         opt4.setEnabled(true);
           ...
           if (count == 9){
            ...
            useranswers[count][0] = groupoption.getSelection().getActionCommand();
             ...
             for(int i=0; i<useranswers.length; i++){
             if (useranswers[i][0].equals(answers[i][i])){
             score +=10;
             } else {  // if you want then use in negative marking
             score += 0; 
               }
